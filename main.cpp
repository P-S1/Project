...
int main() {
    std::vector<Car> carList = {
        ...
        Car("Yamaha", "YFZ", 5000, "Automatic", "Electric", 2, "Scooter"),
        ...
        Car("Yamaha", "YZF-R1", 1100, "Manual", "Gasoline", 2, "Motorcycle"),
        ...
        Car("Yamaha", "MT-09", 200, "Manual", "Gasoline", 2, "Motorcycle"),
        ...
        Car("Yamaha", "VMAX", 600, "Manual", "Gasoline", 2, "Motorcycle"),
